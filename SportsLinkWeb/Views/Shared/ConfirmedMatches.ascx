...
<%@ Import Namespace="SportsLink" %>
    ...
    <% var perPage = 4; %>
    <% var pageModel = PageModel<OfferModel>.Create((int)ViewData["page"], perPage, confirmedMatches.ConfirmedMatches); %>
    
    <div class="module" id="confirmedMatches" data-type="ConfirmedMatches" style='display:<%=pageModel.Items.Count() > 0 ? "" : "none" %>'>
